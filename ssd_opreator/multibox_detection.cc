...
inline void MultiBoxDetectionForward(const Tensor<cpu, 3, DType> &out,
  ...
  for (int nbatch = 0; nbatch < num_batches; ++nbatch) {
    ...
    DType *p_outanchor = outanchor.dptr_ + nbatch * num_anchors * 6;
    int valid_count = 0;
    for (int i = 0; i < num_anchors; ++i) {
      ...
      for (int j = 1; j < num_classes; ++j) {
        ...
        p_outanchor[valid_count*6] = p_out[valid_count*6];
        p_outanchor[valid_count*6+1] = p_out[valid_count*6+1];
        p_outanchor[valid_count*6+2] = p_out[valid_count*6+2];
        p_outanchor[valid_count*6+3] = p_out[valid_count*6+3];
        p_outanchor[valid_count*6+4] = p_out[valid_count*6+4];
        p_outanchor[valid_count*6+5] = p_out[valid_count*6+5];
        ++valid_count;
