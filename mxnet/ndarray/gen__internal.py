...
def _backward_Softmax(out=None, name=None, **kwargs):
    r"""
...
def _backward_batch_dot(out=None, name=None, **kwargs):
    r"""
...
def _backward_log_softmax(lhs=None, rhs=None, out=None, name=None, **kwargs):
    r"""
...
def _backward_softmax(lhs=None, rhs=None, out=None, name=None, **kwargs):
    r"""
